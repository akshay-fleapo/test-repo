...
import { CreateUserByPhoneDto } from './dto/create-user.dto';
...
export class UserService {
  ...
  updateUser(createUserDto: Partial<CreateUserByPhoneDto>) {
  ...
  async createUser(createUserDto: CreateUserByPhoneDto): Promise<User> {
